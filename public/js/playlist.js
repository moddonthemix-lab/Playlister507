...
const CONFIGS = {
  ...
  'kpop': {
    key:        'kpop',
    name:       'EASE IN\nKPOP',
    eyebrow:    '— NewJeans · 4th Gen · K-R&B —',
    desc:       'NewJeans anchored, 4th gen girl groups, K-R&B, and smooth Korean indie. The tracks that actually hit — no fandom required.',
    tags:       ['K-Pop', '25 Tracks', 'NewJeans Lane'],
    heroClass:  'kpop',
...
const SEO_DATA = {
  ...
  'kpop': {
    title:    'Ease In Kpop — Best NewJeans & 4th Gen K-Pop Playlist on Spotify 2025',
    desc:     'Ease In Kpop is Playlist Engine\'s curated 4th gen K-pop playlist anchored by NewJeans. KISS OF LIFE, IVE, aespa, LE SSERAFIM, STAYC, Heize, Dean, Crush — 25 tracks of K-pop, K-R&B, and Korean indie updated every two weeks. No fandom required, just the best Korean music right now.',
    keywords: 'newjeans playlist spotify, 4th gen kpop playlist 2025, kiss of life kpop, IVE aespa le sserafim playlist, korean r&b spotify, k-indie playlist, ease in kpop playlist engine, best kpop songs 2025, stayc kpop playlist',
    ogTitle:  'Ease In Kpop — NewJeans & 4th Gen K-Pop Playlist | Playlist Engine',
    ogDesc:   'NewJeans anchored. 4th gen girl groups, K-R&B, K-indie. 25 tracks, updated every 2 weeks.',
  },
  'summer': {
